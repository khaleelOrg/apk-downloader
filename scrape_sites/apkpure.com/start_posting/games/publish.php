<?php   
    ...
    $parent_category = get_category_by_slug( 'games' );
    ...
    add_post_meta($post_id, 'rank_math_description',$json_obj['title']. " " . $json_obj['version']. " for Android - Download APK - apkfuel.com updated latest version, original playstore game ...",true);
