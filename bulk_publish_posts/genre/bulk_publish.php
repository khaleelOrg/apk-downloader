<?php
										...
										$category = get_category_by_slug( $json_obj['genreId'] );
											...
											echo $title_with_dashes; echo "<br>";
...
// 										echo "<br>Post link is: $file_pointer <br>";
										...
										if ($count == 0)
										{
    										...
    										'option'  		=> 'links',
    										'0' 	  		=> array( 'link'=> 'https://apkfuel.com/apk-downloader/play_api_download_single.php?id='.$appId.'',
    										'texto'     	=> 'Download Link 1',
    										'follow'		=> '1'
                                                                    ),
                                            '1' 	  		=> array( 'link'=> 'https://apkfuel.com/apk-downloader/play_api_download_single.php?id='.$appId.'',
										...
										else 
                                        {
                                        	...
                                        	// $path    = "/home/apkfuel/public_html/apk-downloader/bulk_publish_posts/genre/content/apk_jsons/$appId.json";
                                        	// unlink($path);
