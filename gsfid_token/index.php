...
<meta charset="utf-8" />
	...
	<title>Playstore APK Downloader - Download APP Directly | September 2021</title>
		<meta name="description" content="Google Playstore APK downloader. Faster app downloads and apk file update speed. Best of all, it's free. APK Fuel full APK and OBB data directly from Google Play Store Server." />
                ...
                <meta itemprop="name" content="Playstore APK Downloader - Download APP Directly | September 2021" />
...
<meta property="og:title" content="Playstore APK Downloader - Download APP Directly | September 2021" />
...
<meta name="twitter:title" content="Playstore APK Downloader - Download APP Directly | September 2021" />
...
<!-- <li><a href="javascript:void(0)" onclick="yid_type()" id="b2">Config Guide</a></li> -->
</ul>
</div>
...
<div>
		<select name="arch" id="arch" aria-label="Select Architecture">
...
<option value="6.0" selected>Default</option>
<option value="2.3">Android 2.3</option>
<option value="4.0">Android 4.0</option>
<option value="4.1">Android 4.1</option>
<option value="4.3">Android 4.3</option>
...
function yid_type() {
	...
	document.getElementById('arch').value = 0;
...
ajax('https://apkfuel.com/apk-downloader/gsfid_token/play_api_helper.php','url='+a+'&x=downloader&tbi='+tb+'&av_u='+av_u+'&device_id='+device_id+'&model='+encodeURI(model)+'&hl=en&de_av=&android_ver='+av+'&arch='+arch);
});
