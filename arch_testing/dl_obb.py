...
df1 = pd.read_csv("/home/apkfuel/public_html/apk-downloader/gsfid_token/gsfids_and_tokens_01.csv") #df1 specific functinality
df2 = pd.read_csv("/home/apkfuel/public_html/apk-downloader/gsfid_token/gsfids_and_tokens_01.csv", index_col = 'device') #read a csv file and set index to column = Code_Name
...
#now login
try:
 print("login using gsfid and sub_authentication token")
 ...
 os.rename(file_name + '.apk', file_name + '_' + device_arg + '.apk')

 #above code downloads apk file#

except Exception as ex:
 print(ex)
 # # LOGIN
 # #####Authentication using app password & get gsfid and token #######
 print("login using email & all_rounder_password")
 
 mail = "hk.jigar@gmail.com"
 passwd = "kkyjntzeifdenmts" #all_rounder_password
 print(mail)
 print(passwd)
